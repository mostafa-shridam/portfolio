...
import '../../core/widgets/download_cv_button.dart';
...
class _HomePageState extends ConsumerState<HomePage> with UrlLauncherMixin {
  @override
  void initState() {
    super.initState();
    Future.microtask(
  ...
  Widget build(BuildContext context) {
    ...
    return widget.userId == userData.id
        ? Scaffold(
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  ContactSection(
                      userData: userData, selectedColor: selectedColor),
                ],
              ),
            ),
          )
